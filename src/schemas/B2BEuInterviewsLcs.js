...
// --- Begin: B2B Partner End Users Interviews Lifecycles Schema --- //
...
schema.index({intrw: 1});
schema.index({cDtStr: -1, uDtStr: -1});

module.exports = mongoose.model(config.collB2BEuInterviewsLcs, schema);
// --- End: B2B Partner End Users Interviews Lifecycles Schema --- //